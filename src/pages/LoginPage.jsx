            ...
            <form onSubmit={handleLoginSubmit} className="space-y-5">
              ...
              <div>
                ...
                <input type="text" name="identificador" value={loginData.identificador || ''} onChange={handleLoginChange} placeholder="usuario@ues.edu.mx, usuario@gmail.com o 13220014"
                  className="w-full bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg px-4 py-2.5 text-sm text-gray-900 dark:text-white placeholder-gray-400 placeholder:text-[10px] sm:placeholder:text-sm focus:outline-none focus:ring-2 focus:ring-green-500/30 transition" required />
              </div>
