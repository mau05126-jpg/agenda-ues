          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 lg:p-10 border border-gray-100 dark:border-gray-700 shadow-sm">
            ...
            <form onSubmit={handleLoginSubmit} className="space-y-5">
              ...
              <div>
                ...
                <input type="text" name="identificador" value={loginData.identificador || ''} onChange={handleLoginChange} placeholder={window.innerWidth < 640 ? "Email, Gmail o matrícula" : "usuario@ues.edu.mx, usuario@gmail.com o 13220014"}
