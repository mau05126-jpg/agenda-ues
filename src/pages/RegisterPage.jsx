          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 lg:p-10 border border-gray-100 dark:border-gray-700 shadow-sm">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <input type="email" name="email" value={formData.email} onChange={handleChange} placeholder="usuario@ues.edu.mx o usuario@gmail.com" required className="w-full bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg px-4 py-2.5 text-sm text-gray-900 dark:text-white placeholder-gray-400 placeholder:text-[10px] sm:placeholder:text-sm focus:outline-none focus:ring-2 focus:ring-green-500/30 transition" />
              </div>
