      ...
      <div className="relative z-10 flex-1 flex flex-col justify-end px-4 sm:px-8 pb-6 sm:pb-10 max-w-[1280px] mx-auto w-full">
        <div className="flex flex-col lg:flex-row justify-between items-end gap-6 lg:gap-8">
          ...
          <div className="max-w-lg w-full">
            ...
            <p className="text-gray-200 text-base sm:text-lg font-medium mb-3 sm:mb-4 drop-shadow-md">
              Cultura que Inspira, Conocimiento que Transforma.
            </p>

            <div className="flex flex-wrap items-center gap-3 sm:gap-5 text-xs sm:text-sm text-gray-200 mb-5 sm:mb-6">
          ...
          <div className="flex gap-3 w-full lg:w-auto lg:flex-none">
            <div className="flex-1 lg:flex-none lg:w-44 h-28 lg:h-44 rounded-2xl flex flex-col items-center justify-center text-white" style={cardStyle}>
