      ...
      <div className="relative z-10 flex-1 flex flex-col justify-end px-8 pb-10 max-w-[1280px] mx-auto w-full">
        <div className="flex flex-col lg:flex-row justify-between items-end gap-8">
          ...
          <div className="flex gap-4 flex-wrap justify-center lg:justify-end">
            <div className="w-44 h-44 rounded-2xl flex flex-col items-center justify-center text-white" style={{background:'linear-gradient(135deg, rgba(0,30,10,0.75) 0%, rgba(0,0,0,0.65) 100%)',backdropFilter:'blur(12px)',WebkitBackdropFilter:'blur(12px)',border:'1px solid rgba(74,222,128,0.25)',boxShadow:'0 8px 32px rgba(0,0,0,0.5), inset 0 1px 0 rgba(255,255,255,0.08)'}}>
